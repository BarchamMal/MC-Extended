...
public class MCExtendedSmithingTemplates {
    ...
    private static final Text CORUNDUM_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", Identifier.of(NAMESPACE ,"corundum_upgrade"))).formatted(TITLE_FORMATTING);
    private static final Text CORUNDUM_UPGRADE_APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(NAMESPACE ,"smithing_template.corundum_upgrade.applies_to"))).formatted(DESCRIPTION_FORMATTING);
    private static final Text CORUNDUM_UPGRADE_INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(NAMESPACE ,"smithing_template.corundum_upgrade.ingredients"))).formatted(DESCRIPTION_FORMATTING);
    private static final Text CORUNDUM_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(NAMESPACE ,"smithing_template.corundum_upgrade.base_slot_description")));
    private static final Text CORUNDUM_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(NAMESPACE ,"smithing_template.corundum_upgrade.additions_slot_description")));
    ...
    public static void RegisterItems() {
        ...
        Registry.register(Registries.ITEM, Identifier.of(NAMESPACE, "corundum_upgrade_smithing_template"), CORUNDUM_UPGRADE_SMITHING_TEMPLATE);
