...
public class VillagerProfessions {
    ...
    public static void registerProfessions() {
        GEM_DEALER = Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(NAMESPACE, "gem_dealer"),
        ...
        MINER = Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(NAMESPACE, "miner"),
        ...
        BOTANIST = Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(NAMESPACE, "botanist"),
