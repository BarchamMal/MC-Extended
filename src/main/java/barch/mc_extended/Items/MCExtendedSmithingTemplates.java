...
//    private static final Text CORUNDUM_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", Identifier.of(MC_EXTENDED,"corundum_upgrade"))).formatted(TITLE_FORMATTING);
    public static final Text CORUNDUM_UPGRADE_APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(MC_EXTENDED,"smithing_template.corundum_upgrade.applies_to"))).formatted(DESCRIPTION_FORMATTING);
    public static final Text CORUNDUM_UPGRADE_INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(MC_EXTENDED,"smithing_template.corundum_upgrade.ingredients"))).formatted(DESCRIPTION_FORMATTING);
    public static final Text CORUNDUM_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(MC_EXTENDED,"smithing_template.corundum_upgrade.base_slot_description")));
    public static final Text CORUNDUM_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(MC_EXTENDED,"smithing_template.corundum_upgrade.additions_slot_description")));

    public static List<Identifier> getCorundumUpgradeEmptyBaseSlotTextures() {
    ...
    public static List<Identifier> getCorundumUpgradeEmptyAdditionsSlotTextures() {
