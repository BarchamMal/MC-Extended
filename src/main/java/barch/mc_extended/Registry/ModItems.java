...
public class ModItems {
    ...
    public static final Item BRONZE_AXE = registerTool(Tools.BRONZE_TD, Tools.TlType.AXE, 2, -3.1f);
    public static final Item BRONZE_HOE = registerTool(Tools.BRONZE_TD, Tools.TlType.HOE, -5, 1f);
    public static final Item BRONZE_PICKAXE = registerTool(Tools.BRONZE_TD, Tools.TlType.PICKAXE, -2, -2.5f);
    public static final Item BRONZE_SHOVEL = registerTool(Tools.BRONZE_TD, Tools.TlType.SHOVEL, -1.5f, -3f);
    public static final Item BRONZE_SWORD = registerTool(Tools.BRONZE_TD, Tools.TlType.SWORD, 0, -2.4f);
    public static final Item COPPER_AXE = registerTool(Tools.COPPER_TD, Tools.TlType.AXE, 2, -3.1f);
    public static final Item COPPER_HOE = registerTool(Tools.COPPER_TD, Tools.TlType.HOE, -5, -1f);
    public static final Item COPPER_PICKAXE = registerTool(Tools.COPPER_TD, Tools.TlType.PICKAXE, -2, -2.5f);
    public static final Item COPPER_SHOVEL = registerTool(Tools.COPPER_TD, Tools.TlType.SHOVEL, 1.5f, -3f);
    public static final Item COPPER_SWORD = registerTool(Tools.COPPER_TD, Tools.TlType.SWORD, 0, -2.4f);
    public static final Item CORUNDUM_AXE = registerTool(Tools.CORUNDUM_TD, Tools.TlType.AXE, 5, -3f);
    public static final Item CORUNDUM_HOE = registerTool(Tools.CORUNDUM_TD, Tools.TlType.HOE, -5, 0f);
    public static final Item CORUNDUM_PICKAXE = registerTool(Tools.CORUNDUM_TD, Tools.TlType.PICKAXE, 0, -2f);
    public static final Item CORUNDUM_SHOVEL = registerTool(Tools.CORUNDUM_TD, Tools.TlType.SHOVEL, 1.5f, -3f);
    public static final Item CORUNDUM_SWORD = registerTool(Tools.CORUNDUM_TD, Tools.TlType.SWORD, 4, -2f);
    public static final Item RUBY_AXE = registerTool(Tools.RUBY_TD, Tools.TlType.AXE, 5, -3f);
    public static final Item RUBY_HOE = registerTool(Tools.RUBY_TD, Tools.TlType.HOE, -3, 0f);
    public static final Item RUBY_PICKAXE = registerTool(Tools.RUBY_TD, Tools.TlType.PICKAXE, 0, -2.8f);
    public static final Item RUBY_SHOVEL = registerTool(Tools.RUBY_TD, Tools.TlType.SHOVEL, 1.5f, -3f);
    public static final Item RUBY_SWORD = registerTool(Tools.RUBY_TD, Tools.TlType.SWORD, 3, -2f);
    public static final Item SAPPHIRE_AXE = registerTool(Tools.SAPPHIRE_TD, Tools.TlType.AXE, 5, -3f);
    public static final Item SAPPHIRE_HOE = registerTool(Tools.SAPPHIRE_TD, Tools.TlType.HOE, -3, 0f);
    public static final Item SAPPHIRE_PICKAXE = registerTool(Tools.SAPPHIRE_TD, Tools.TlType.PICKAXE, 0, -2.8f);
    public static final Item SAPPHIRE_SHOVEL = registerTool(Tools.SAPPHIRE_TD, Tools.TlType.SHOVEL, 1.5f, -3f);
    public static final Item SAPPHIRE_SWORD = registerTool(Tools.SAPPHIRE_TD, Tools.TlType.SWORD, 3, -2f);
    public static final Item SILVER_AXE = registerTool(Tools.SILVER_TD, Tools.TlType.AXE, 5, -3f);
    public static final Item SILVER_HOE = registerTool(Tools.SILVER_TD, Tools.TlType.HOE, -5, 0f);
    public static final Item SILVER_PICKAXE = registerTool(Tools.SILVER_TD, Tools.TlType.PICKAXE, 0, -2f);
    public static final Item SILVER_SHOVEL = registerTool(Tools.SILVER_TD, Tools.TlType.SHOVEL, 1.5f, -3f);
    public static final Item SILVER_SWORD = registerTool(Tools.SILVER_TD, Tools.TlType.SWORD, 4, -2f);
    public static final Item TIN_AXE = registerTool(Tools.TIN_TD, Tools.TlType.AXE, 2, -3.1f);
    public static final Item TIN_HOE = registerTool(Tools.TIN_TD, Tools.TlType.HOE, -5, -1f);
    public static final Item TIN_PICKAXE = registerTool(Tools.TIN_TD, Tools.TlType.PICKAXE, 2, -2.5f);
    public static final Item TIN_SHOVEL = registerTool(Tools.TIN_TD, Tools.TlType.SHOVEL, 1.5f, -3f);
    public static final Item TIN_SWORD = registerTool(Tools.TIN_TD, Tools.TlType.SWORD, 0, -2.4f);
    ...
    public static final Item SAAG = registerContainedFood("saag", new Item.Settings(), Items.BOWL);
