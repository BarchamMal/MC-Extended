...
public class ModProfessions {
    ...
    public static void registerProfessions() {
        GEM_DEALER = Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(MC_EXTENDED, "gem_dealer"),
                new VillagerProfession(Text.translatable("entity.mc-extended.villager.gem_dealer"), holder -> holder.value().equals(VillagerPOIs.GEM_DEALER_POI), holder -> holder.value().equals(VillagerPOIs.GEM_DEALER_POI),
        ...
        MINER = Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(MC_EXTENDED, "miner"),
                new VillagerProfession(Text.translatable("entity.mc-extended.villager.miner"), holder -> holder.value().equals(VillagerPOIs.MINER_POI), holder -> holder.value().equals(VillagerPOIs.MINER_POI),
        ...
        BOTANIST = Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(MC_EXTENDED, "botanist"),
                new VillagerProfession(Text.translatable("entity.mc-extended.villager.botanist"),holder -> holder.value().equals(VillagerPOIs.BOTANY_POI), holder -> holder.value().equals(VillagerPOIs.BOTANY_POI),
